...
class Network(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, context=False):
        super(Network, self).__init__()
        self.unet = UNet_v2(image_size=128, in_channel=in_channels, out_channel=out_channels)
    ...
    def forward(self, x, t, y, x_end, adjust=True):
        ...
        # print("unetout",out.min().item(), out.max().item())
        return out


# WeightNet of the one-shot learning framework
class WeightNet(nn.Module):
    def __init__(self, weight_num=20):
